...
.register_default_assays <- function() {
  ...
  register_assay("ldr_p", role = "p", units = "ROI p-value")
  register_assay("ldr_fwer_p", role = "p", units = "search-family FWER p-value")
  register_assay("ldr_flag", role = "evidence", units = "-log10 FWER p-value")
  register_assay("ldr_activation_fwer_p", role = "p", units = "search-family FWER p-value")
  register_assay("ldr_displacement_fwer_p", role = "p", units = "search-family FWER p-value")
  register_assay("ordinary_fwer_p", role = "p", units = "search-family FWER p-value")
  register_assay("tangent_activation_t", role = "t", units = "studentized directional evidence")
  register_assay("tangent_displacement_t", role = "t", units = "studentized tangent energy")
  register_assay("ordinary_t", role = "t", units = "t statistic")
  register_assay("tangent_mni_loss", role = "evidence", units = "t-statistic difference")
  register_assay("tangent_shift_rms_mm", role = "evidence", units = "mm")
  register_assay("rho_shift", role = "evidence", units = "fraction")
  register_assay("mni_loss", role = "evidence", units = "t-statistic difference")
  register_assay("shift_rms_mm", role = "evidence", units = "mm")
}
